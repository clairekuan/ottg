...
class ManyListsTest(TodoFunctionalTest):
    ...
    def test_can_create_and_view_multiple_lists(self):
        #Edith comes to the home page and creates a new list
        #She fills in her grocery list
        ...
        #She notices that she can change a list name
        ...
        #Edith goes to the grocery list.  She sees what she needs to buy.
